...
export function Footer({ locale }: { locale: AppLocale }) {
  return (
    <footer className="field-footer py-12">
      <Container className="flex flex-col gap-8 sm:flex-row sm:items-end sm:justify-between">
        <div className="max-w-lg">
          ...
          <p className="field-muted">{message('footer_tagline', locale)}</p>
        ...
        <p className="field-footer-meta pt-5 text-sm sm:border-t-0 sm:pt-0 sm:text-right">
